  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        {[
          { id: "email-incidents", label: "Incident alerts", description: "Receive emails when new incidents are opened or escalated", defaultChecked: true },
          { id: "email-deploys", label: "Deployment notifications", description: "Get notified on deployment success, failure, or rollback", defaultChecked: false },
          { id: "email-security", label: "Security alerts", description: "Get notified about vulnerabilities and compliance issues", defaultChecked: true },
          { id: "push-alerts", label: "Push notifications", description: "Receive push notifications for real-time infrastructure alerts", defaultChecked: true },
          { id: "weekly-digest", label: "Weekly digest", description: "Get a summary of your weekly infrastructure metrics", defaultChecked: false },
        ].map((pref) => (
